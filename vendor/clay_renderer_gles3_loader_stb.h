...
Clay_Dimensions Stb_MeasureText(Clay_StringSlice glyphVtxArray,
...
#ifndef CLAY_RENDERER_GLES3_LOADER_STB_IMPLEMENTATION
extern LoadedImageInternal g_imageSlot;
#endif

#ifdef CLAY_RENDERER_GLES3_LOADER_STB_IMPLEMENTATION
...
)
{
    ...
    fclose(f);
    bool result = Stb_LoadFontMemory(textureOut, fontOut, ttf_buf, sz, bakePxH, atlasW, atlasH);;
    free(ttf_buf);
    return result;
}

 Clay_Dimensions Stb_MeasureText(
