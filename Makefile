...
all: wayland_stuff build/main.o build/implementations.o build/irc.o
	$(CC) $(CFLAGS) $(LDFLAGS) -o $(TARGET) build/wayland_protocols/xdg-shell.o build/wayland_protocols/xdg-toplevel-icon-v1.o build/wayland_protocols/xdg-decoration-unstable-v1.o build/wayland_protocols/relative-pointer-unstable-v1.o build/wayland_protocols/pointer-constraints-unstable-v1.o build/wayland_protocols/xdg-output-unstable-v1.o build/main.o build/implementations.o build/irc.o
...
build/irc.o: src/irc.c src/da.h src/irc.h
